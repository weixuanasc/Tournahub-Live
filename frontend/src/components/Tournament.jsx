...
function ViewTournament() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        if (user) {
          const response = await axios.get(
            `https://api.fyp23s424.com/getTournaments/${user._id}?sortBy=tournamentStartDate`
          );
          // Parse dates if needed
          const tournamentsWithParsedDates = response.data.map(
            (tournament) => ({
              ...tournament,
          ...
          tournamentsWithParsedDates.sort(
            (a, b) =>
              new Date(a.tournamentStartDate) - new Date(b.tournamentStartDate)
          );
  ...
  const handleSearch = async (searchTerm) => {
    ...
    if (searchTerm.trim() === "") {
      ...
      try {
        const response = await axios.get(
          `https://api.fyp23s424.com/searchTournaments/${searchTerm}/${user._id}`
        );
      ...
      {loading ? (
        ...
        <>
          {(searchTerm.trim() === ""
            ...
            (tournament) =>
              !statusFilter || tournament.tournamentStatus === statusFilter
          ).length === 0 ? (
              ...
              <tbody>
                {(searchTerm.trim() === "" ? tournaments : filteredTournaments)
                  .filter(
                    (tournament) =>
                      (!statusFilter ||
                        tournament.tournamentStatus === statusFilter) &&
                      (!sportFilter ||
                        tournament.tournamentSport === sportFilter)
                  )
                  .map((tournament) => (
                    <tr
                      key={tournament._id}
                    ...
                    >
                      <td className="tournament-box">
                        <div>
                          ...
                          <p>
                            <strong>Sport:</strong> {tournament.tournamentSport}
                          </p>
                          <p>
                          ...
                          <p>
                            ...
                            {tournament.tournamentNumberofmatches}
                          </p>
                          <p>
                            <strong>Date:</strong>{" "}
                        ...
                        <div className="action-buttons">
                          <button
                            onClick={() =>
                              handleNavigateToViewTournamentDeatils(
                                tournament._id
                              )
                            }
                          ...
                          <button
                            onClick={() =>
                              handleNavigateToUpdateTournament(tournament._id)
                            }
                          ...
                          <button
                            onClick={() =>
                              handleNavigateToAddMatches(tournament._id)
                            }
                          ...
                          <button
                            onClick={() =>
                              handleNavigateToUpdateMatches(tournament._id)
                            }
                            className="btn btn-sm btn-warning mr-2"
                          >
                            Edit Matches
                          ...
                          <button
                            onClick={() =>
                              handleNavigateToCreateRankingTable(tournament._id)
                            }
                        ...
                        <div className="additional-buttons">
                          <button
                            onClick={() =>
                              handleNavigateViewApplicants(tournament._id)
                            }
                          ...
                          <button
                            onClick={() =>
                              handleNavigateInvitationPage(tournament._id)
                            }
                            className="btn btn-sm btn-info"
                          >
                            Send Invite
                          ...
                          <button
                            onClick={() =>
                              handleNavigateToScheduleGuide(tournament._id)
                            }
                            className="btn btn-sm btn-success mr-2"
                          >
                            Schedule Guide
