...
function SponsorshipModels() {
  const handleCheckoutIcon = async () => {
    try {
      const response = await axios.post("https://api.fyp23s424.com/create-checkout-session-icon");
  ...
  const handleCheckoutTournament = async () => {
    try {
      const response = await axios.post("https://api.fyp23s424.com/create-checkout-session-tournament");
  ...
  const handleCheckoutArticle = async () => {
    try {
      const response = await axios.post("https://api.fyp23s424.com/create-checkout-session-article");
