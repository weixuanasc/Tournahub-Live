...
function SponsorTournament() {
    ...
    const fetchTournaments = async () => {
      try {
        const response = await axios.get(
          "https://api.fyp23s424.com/getSponsorableTournaments"
        );
  ...
  const handleSubmit = async (e) => {
    ...
    const submit = await axios
      .post("https://api.fyp23s424.com/sponsorTournament", formData, {
          ...
          <div className="mb-3">
            ...
            >
              {tournament.map((tournaments) => (
                <option
                  key={tournaments.tournamentName}
                  value={tournaments._id}
                >
